...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
	...
	if ($_GET['mod'] == 'bahan_kuliah_dosen' && $_GET['act'] == 'input'){
		...
		if ($upload){
			$db->database_prepare("INSERT INTO as_bahan_kuliah (	judul,
														...
														->execute(	$_POST["judul"],
																	...
																	"",
																	"");
			header("Location: ../../index.php?mod=bahan_kuliah_dosen&code=1");
		}
		else{
			header("Location: ../../index.php?mod=bahan_kuliah_dosen&code=4");
		}
	} 
	
	elseif ($_GET['mod'] == 'bahan_kuliah_dosen' && $_GET['act'] == 'update'){
			...
			if ($upload){
				$db->database_prepare("UPDATE as_bahan_kuliah SET	judul = ?,
														...
														->execute(	$_POST["judul"],
																	...
																	$_SESSION["userid"],
																	$_POST["id"]);
				header("Location: ../../index.php?mod=bahan_kuliah_dosen&code=2");
			}
			else{
				header("Location: ../../index.php?mod=bahan_kuliah_dosen&code=4");
			}
	...
	elseif ($_GET['mod'] == 'bahan_kuliah_dosen' && $_GET['act'] == 'delete'){
		...
		if ($unlink){
			...
			header("Location: ../../index.php?mod=bahan_kuliah_dosen&code=3");
		}
	}
}
?>