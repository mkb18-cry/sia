...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
	...
	$content = "
				...
				<table border=0>
					<tr>
						<td align=center width=698><h4>Rekapitulasi Pembayaran Harian (Periode)</h4></td>
					</tr>
				</table>
				<table>
					<tr>
					...
					<tr>
						<td>Periode</td>
						<td>:</td>
						<td><b>$tanggal_awal s/d $tanggal_akhir</b></td>
					</tr>
					<tr>
						<td>Tanggal Cetak</td>
						<td>:</td>
				...
				<tr>
					...
					<th width=100 align='center' bgcolor='#B7D577'>Gedung</th>
					<th width=100 align='center' bgcolor='#B7D577'>SPP</th>
					<th width=100 align='center' bgcolor='#B7D577'>SKS</th>
				</tr>";
				$i = 1;
