		...
		echo "<a href='index.php?mod=nilai'><img src='../images/back.png'></a>
			...
			<div class='box round first fullpage'>
				...
				<table class='data display datatable' id='example'>
					...
					$i = 1;
				$sql_data = $db->database_prepare("SELECT B.sks_mata_kuliah, B.kode_mata_kuliah, B.nama_mata_kuliah_eng, A.tugas, A.uts, A.uas, A.total, C.jadwal_id
