		...
		<div class="block ">
			...
			<table class='form'>
				<tr valign="top">
					...
					<td><input type="text" name="nim" class="required" size="40" id="getnim"></td>
				</tr>
				<tr valign="top">
					<td><label>Semester</label></td>
					<td><input type="text" name="semester" class="required" size="40"></td>
				</tr>
				<tr valign="top">
					<td></td>
...
<?php
	...
	echo "<a target='_blank' href='modul/mod_nilai/export_khs.php?id=$data_mhs[id_mhs]&semester=$_GET[semester]'><button type='button' class='btn btn-green'>Export KHS</button></a>";
	break;
