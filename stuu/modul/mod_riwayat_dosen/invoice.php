...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
	...
	$content = "
				...
				<table cellpadding=0>
					<tr>
						<th width='25' style='border-bottom: 1px solid;' bgcolor='#245284'>No.</th>
						<th align='center' width='100' style='border-bottom: 1px solid;' bgcolor='#245284'>Kode MTK</th>
						<th align='center' width='350' style='border-bottom: 1px solid;' bgcolor='#245284'>Nama MTK</th>
						<th width='120' align='center' style='border-bottom: 1px solid;' bgcolor='#245284'>Jumlah SKS</th>
					</tr>
			";
			$i = 1;
			...
			$content .= "<tr>
						...
						<td style='border-bottom: 1px solid;'>$data_krs[kode_mata_kuliah]</td>
						<td style='border-bottom: 1px solid;'>$data_krs[nama_mata_kuliah_ind]</td>
						<td style='border-bottom: 1px solid;' align='center'>$data_krs[sks_mata_kuliah]</td>
					</tr>";
			...
			$content .= "
					<tr>
						<td colspan='3' align='right'><b>Total SKS</b></td>
						<td style='border-bottom: 1px solid;' align='center'><b>$grand_sks</b></td>
					</tr>
					</table>
					<p>&nbsp;</p>
					<table>
						<tr>
							<td width='400'></td>
							<td align='center'>Jakarta, $now<br>
							BAAK<br>
								<p><img src='../../../favicon.jpg'></p>
